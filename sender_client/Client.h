...
public:
    ...
    void init();
    void close(ns_cl_core::network::channel_id_type control_channel_id, out<corelink::client::corelink_classic_client> client);

    corelink::core::network::channel_id_type getHostId()const;
